...
const AgencyPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="button-group flex justify-center space-x-4 mb-6">
        <Button variant="default">Obrni (switch stations)</Button>
        <Button variant="default">Pretraži (search)</Button>
        <Button variant="default">Prijavite problem / Predložite funkciju</Button>
      </div>
